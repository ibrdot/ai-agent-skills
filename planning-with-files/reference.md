...
**Solution:** Re-read `.claude/planning/task_plan.md` before each decision. Goals appear in the attention window.

```
Start of context: [Original goal - far away, forgotten]
...many tool calls...
End of context: [Recently read .claude/planning/task_plan.md - gets ATTENTION!]
```
...
|------|---------|--------------|--------------|
| `.claude/planning/task_plan.md` | Phase tracking, progress | Task start | After completing phases |
| `.claude/planning/findings.md` | Discoveries, decisions | After ANY discovery | After viewing images/PDFs |
| `.claude/planning/progress.md` | Session log, what's done | At breakpoints | Throughout session |
