...
See [Bar Chart](assets/charts-bar-chart.tsx) for a full animated bar chart example with axes, labels, and spring animations.
...
Docs: https://remotion.dev/docs/paths
